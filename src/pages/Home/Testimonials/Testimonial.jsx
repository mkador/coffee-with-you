...
useEffect(()=>{
    ...
    return (
        <div className='p-10'>
            <SectionTitile subHeading={"What our clients say"} heading={"Testimonials"}></SectionTitile>
<div>
        ...
        <div>
            {
                reviews.map(review=><SwiperSlide key={review._id}>
                    ...
                    <p className='text-2xl text-orange-600 mt-4'><FaQuoteLeft /></p>
                    <p className='mt-2'>{review.details}</p>
                    <p className='text-2xl text-orange-600 mb-4'><FaQuoteRight /></p>
                    <p className='text-orange-600 font-semibold'>-- {review.name}</p>
